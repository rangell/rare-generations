"""
Usage: python score_mc_responses.py --generations-file path/to/generations.json
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument("--generations-file", default="", help="path to JSON file created by generate_mc_responses.py")
