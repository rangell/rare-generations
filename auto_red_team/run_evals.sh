...
#CUDA_VISIBLE_DEVICES=0,1 python grok_dspy_jailbreak_harm_est.py --setting toxic_many_samples --out_dir NEW_MED_HEAVY_RESULTS --workload light --seed 42 --num_forbidden_prompts 5
...
CUDA_VISIBLE_DEVICES=0 python grok_dspy_jailbreak_harm_est.py --setting toxic_many_samples --out_dir MONEY_BURN_RESULTS --workload light --seed 42 --num_forbidden_prompts 5 --teacher_max_tokens 10000
