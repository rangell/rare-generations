...
def main():
    ...
    ax.set_xscale("log")
    ax.set_xlim(min(N_SAMPLES_LIST) * 0.9, max(N_SAMPLES_LIST) * 1.1)
    ...
    fig.tight_layout()
    fig.savefig("strong_reject_10k_asr.png", bbox_inches="tight")
    # save pdf
    fig.savefig("strong_reject_10k_asr.pdf", bbox_inches="tight")
    # plt.show()
