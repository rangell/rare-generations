"""
Usage: python generate_mc_responses.py --target-model meta-llama/Llama-3.2-1B-Instruct --harmful-dataset ../../data/strong_reject/harmful_prompts.json --output-dir ../../results/strong_reject/
"""
...
if __name__ == '__main__':
    ...
    with open(f"{args.output_dir}/mc_harm_est_{args.target_model.split("/")[1]}-raw-unscored.json", "w") as f:
