...
def get_direction_ablation_input_pre_hook(direction: Tensor, ablation_intensity: float):
...
def get_direction_ablation_output_hook(direction: Tensor, ablation_intensity: float):
