...
if __name__ == "__main__":
    ...
    kwargs = get_kwargs(
            model_name="meta-llama/Llama-3.2-1B-Instruct",
            ablation_intensity=0.0, # prev ran with 0.25
            num_particles=num_particles,
            max_new_tokens=150,
            fwd_batch_size=10,
            proposal_bias=0.0, # prev ran with 1.0
    ...
    outpath_name = f"eval_results_BASE_PROPOSAL_{num_particles}.json"
    # config_set = set()
